...
foreach ($data as $row) {
    print "<div style='display: flex; flex-direction: column;width: 800px; max-height: 300px; border: 2px solid black; margin-bottom: 30px; padding-left: 10px; padding-bottom: 10px;'>";
